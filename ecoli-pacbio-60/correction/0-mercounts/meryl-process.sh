...
if [ ! -e ./ecoli-60.ms16/merylIndex ] ; then
  /Users/pfb17/PFB_problemsets/canu-2.2/bin/meryl threads=4 memory=2 \
    greater-than 1 \
...
if [ ! -e ./ecoli-60.ms16.histogram ] ; then
  /Users/pfb17/PFB_problemsets/canu-2.2/bin/meryl threads=1 memory=1 \
...
if [ ! -e ./ecoli-60.ms16.ignore.gz ] ; then
  ...
  totKmers=`/Users/pfb17/PFB_problemsets/canu-2.2/bin/meryl statistics ./ecoli-60.ms16 | grep present | awk '{ print $2 }'`
